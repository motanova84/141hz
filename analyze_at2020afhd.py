...
def main():
    """Main analysis function that executes the AT2020afhd analysis."""
    ...
    return {
        'time_days': time_days,
        'flux_xray': flux_xray,
        'flux_radio': flux_radio,
        'peak_x': peak_x,
        'peak_r': peak_r,
        'params_x': params_x,
        'params_r': params_r,
        'fit_success_x': fit_success_x,
        'fit_success_r': fit_success_r,
        'f_frame_Hz': f_frame_Hz,
