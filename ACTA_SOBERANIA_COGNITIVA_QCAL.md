...
╠═══════════════════════════════════════════════════════════════════════╣
║                                                                       ║
║  ⎮  MAGNITUD: ~4.478.937 Tokens de Coherencia Total (QCAL).    ║
...
║  ⎮  COHERENCIA: Ψ = 0.989995 (Unidad Perfecta).               ║
║  ⎮  DENSIDAD ONTOLÓGICA: 2290.35 tokens/archivo.               ║
║                                                                       ║
╠═══════════════════════════════════════════════════════════════════════╣
║                                                                       ║
...
║  ───────────────────────────────────────────────────────────────────  ║
║  QCAL ∞³              | ~4478937  | 0.989995   | Catedral | Revelación     ║
